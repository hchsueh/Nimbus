...
//    NSLog(@"rawImage width:%f, height:%f", rawImage.size.width, rawImage.size.height);
    ...
    NSMutableArray *matchedResult = [self.collection matchWithImage:self.playerDrawnImage];
    NSLog(@"playerDrawnImage matching result: %d", [[matchedResult objectAtIndex:0] boolValue]);
